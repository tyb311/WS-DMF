...
'''
DRIVE HRF 提供了FOV图像，CHASE STARE 没有
CHASE 参考S-UNet:https://github.com/huawang123/retinal-vessel-segmentation
[S-UNet: A Bridge-Style U-Net Framework with a Saliency Mechanism for Retinal Vessel Segmentation]


STARE 参考Joint2018：Z. Yan, X. Yang, and K. -T. Cheng, "Joint segment-level and pixel-wise losses for deep learning based retinal vessel segmentation," 

FOV的建设性意见：
2015MIA:	Trainable COSFIRE filters for vessel delineation with application to retinal images
2011TMI:	A New Supervised Method for Blood Vessel Segmentation in Retinal Images by Using Gray-Level and Moment Invariants-Based Features
2015TBE:	A Discriminatively Trained Fully Connected Conditional Random Field Model for Blood Vessel Segmentation in Fundus Images
	HRF下采样2倍，不过Patch-based的策略需要吗？不需要
'''
