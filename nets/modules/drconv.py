...
# https://mp.weixin.qq.com/s/z7AkTmXYyH5ytFC90g3v9Q
if __name__ == '__main__':
    B = 16
    in_channels = 64
    out_channels = 32
    size = 64
    net = DRConv2d(in_channels, out_channels, kernel_size=3, padding=1, region_num=8)
    net.train()

    input = torch.rand(B, in_channels, size, size)
    output = net(input)
